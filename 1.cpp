...
std::map <int, std::string> days = { //Cловарь дней
	{1, "Первое"},{2, "Второе"},{3, "Третье"},
	{4, "Четвертое"},{5, "Пятое"},{6, "Шестое"},{7, "Седьмое"},
    {8, "Восьмое"},{9, "Девятое"},{10, "Десятое"},{11, "Одиннадцатое"},
...
std::map <int, std::string> months = {	//Cловарь месяцев
...
int main() {
	...
	std::cout << days[day] << " " << months[month] << "!!!" << std::endl; // Вывод результата
	return 0;
} 
